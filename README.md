...
Le but de ce projet qui comptera dans la note finale de la matière <ins>*Projet C*</ins>, est de reproduire le jeu **Space Invaders**, sans en faire une copie parfaite du jeu original, mais de le reproduire à notre façon en fonction de notre niveau en programmation dans le langage de programmation **C**.
